            ...
            <CardContent className="p-4 text-xs text-slate-700 dark:text-slate-300">
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                  <div className="mb-2">
                    <strong>To start Superpower Proxy:</strong>
                  </div>
                  ...
                  <div className="mt-2 text-xs">
                    ...
                    <div className="mt-3 p-2 bg-blue-50 dark:bg-blue-900/20 rounded border border-blue-200 dark:border-blue-800">
                      <div className="font-medium text-blue-800 dark:text-blue-200 mb-1">馃摗 Public Endpoints Supported:</div>
                      <div className="text-blue-700 dark:text-blue-300 space-y-1">
                        <div>鈥?<strong>Zapier:</strong> Public MCP endpoints with CORS enabled</div>
                        <div>鈥?<strong>Composio:</strong> SSE and Streamable HTTP endpoints</div>
                        <div>鈥?<strong>Custom servers:</strong> Any MCP server with CORS headers</div>
                      </div>
                    ...
                    {/* <div className="mt-3 p-2 bg-green-50 dark:bg-green-900/20 rounded border border-green-200 dark:border-green-800">
                      <div className="font-medium text-green-800 dark:text-green-200 mb-2">馃實 Example Public Endpoints:</div>
                      <div className="text-green-700 dark:text-green-300 space-y-1 text-xs">
                        <div><strong>SSE:</strong></div>
                        <div className="ml-2">鈥?<code>https://api.zapier.com/v1/mcp/sse</code></div>
                        <div className="ml-2">鈥?<code>https://composio.dev/api/mcp/sse</code></div>
                        <div className="mt-2"><strong>Streamable HTTP:</strong></div>
                        <div className="ml-2">鈥?<code>https://api.zapier.com/v1/mcp</code></div>
                        <div className="ml-2">鈥?<code>https://composio.dev/api/mcp</code></div>
                        <div className="ml-2">鈥?<code>https://your-server.com/mcp</code></div>
                      </div>
                    </div> */}
                  </div>
                </div>
