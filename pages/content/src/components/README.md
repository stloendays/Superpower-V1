...
This directory contains React components that make up the user interface of the Superpower content script, integrated with the modern plugin architecture and state management system.
