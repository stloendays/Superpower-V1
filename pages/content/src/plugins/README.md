...
This directory contains the core components for the Superpower's plugin architecture, implementing a modern Zustand-based system for extensible website adapters.
