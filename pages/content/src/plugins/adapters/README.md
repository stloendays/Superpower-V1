...
This directory contains concrete implementations of Adapter Plugins for the Superpower. Adapters are specialized plugins designed to tailor the assistant's behavior and capabilities to specific websites or types of websites.
