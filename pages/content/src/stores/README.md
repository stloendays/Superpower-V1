...
This directory contains all Zustand state management stores for the Superpower content script. The stores provide centralized, reactive, and type-safe state management with optimal performance characteristics.
