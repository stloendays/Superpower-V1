...
This package contains shared TypeScript types, utilities, and constants used across the Superpower extension, particularly between the content script and background script components.
